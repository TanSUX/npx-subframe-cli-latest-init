...
/*
 * Documentation:
 * Text Area — https://app.subframe.com/f8c9bc078ebe/library?component=Text+Area_4ec05ee8-8f1c-46b2-b863-5419aa7f5cce
 */
  ...
  return (
    <textarea
      className={SubframeUtils.twClassNames(
        "group/c981d7da min-h-[96px] w-full border-none bg-transparent px-2 py-1.5 text-default-font outline-none placeholder:text-neutral-400 font-['Barlow'] text-[14px] font-[400] leading-[20px] tracking-normal",
        className
      )}
